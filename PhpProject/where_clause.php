...
echo $num . " records found in the database<br>";   // (.)dot concatinate operator

$no=1;  // we print this new variavle to see numbers by not taking sno.
...
// Usage of WHERE Clasue to Update Data
